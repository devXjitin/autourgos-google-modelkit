...
Example:
    >>> from autourgos_google_modelkit.textmodel import MODEL, THINKING_LEVEL, GoogleTextModel
    >>> 
    >>> # Class-based
...
from .models import MODEL, THINKING_LEVEL, MODEL_PRICING_USD_PER_MILLION, resolve_model_pricing
from .base import (
    GoogleTextModel,
